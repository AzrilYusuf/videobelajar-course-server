...
const reqRateLimiterMiddleware_1 = __importDefault(require("../middlewares/reqRateLimiterMiddleware"));
...
authRouter.post('/refresh-token', reqRateLimiterMiddleware_1.default, auth_controller_1.default.regenerateAccessToken);
